...
More options of [gcd_gof_plot] can be found from its help
page.

# A Bubble Plot of Goodness of Fit Measure, Mahalanobis Distance, and Generalized Cook's Distance

We can also use [gcd_gof_md_plot] to plot a bubble plot
...
More options of [gcd_gof_md_plot] can be found from its help
page.