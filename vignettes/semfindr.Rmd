...
This document illustrates how to use it to implement the
leave-one-out approach for casewise sensitivity analysis presented
by  Pek and MacCallum (2011), with some plots based on similar
