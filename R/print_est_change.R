...
#' by [est_change_raw()] (DFTHETA or DFZTHETA)
#' or [est_change_raw_approx()] (approximate DFTHETA) and `sort_by` is
#' not `NULL`, then
#' each column is sorted individually, with case IDs inserted
#' before each column. If the output was generated by
#' [est_change()] (DFTHETAS) or [est_change_approx()] (approximate DFTHETAS) and `sort_by`
